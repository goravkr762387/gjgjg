    ...
    <div class="cus_bg1 ">
        <div class="container">
            ...
            <form id="app_form" name="app_form" action="add_user_bank" method="POST" class="form form-horizontal" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="div7 hidden" style="padding: 5px;background:#fff;margin:10px 5px 5px 5px;">
                    <div class="" style="margin:20px 20px;">
                        ...
                        <div class="col-md-12 mt-2">
                            <div class="row required">
                                <b for="otp_3" class="col-md-5 col-form-label">Enter OTP</b>
                                <div class="col-md-7">
                                    <input type="text" id="otp_3" class="form-control allow_number" required name="otp_3" maxlength="8" onKeyPress="if(this.value.length==8) return false;" autocomplete="off" />
                                    <small id="otp_countdown"></small>
                                    <small class="hidden"><a href="javascript:;">Resend OTP</a></small>
                                </div>
                            </div>
                        </div>
                        <div style="margin-top: 10px;">
                            <button type="button" class="cus_btn div7_btn" onclick="final_submit()">Login</button>
                        </div>
                    </div>
                </div>
